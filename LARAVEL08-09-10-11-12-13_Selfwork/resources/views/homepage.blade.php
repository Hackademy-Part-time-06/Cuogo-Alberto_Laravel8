<x-main>
    <x-slot name="title">LIBRARY | Homepage</x-slot>
        ...
        <div class="row g-4s text-center align-items-center min-vh-75 mt-5">
            <div class="col-4">
                <div class="card pb-4">
                    ...
                    <div class="card-body mt-5 pt-5">
                      ...
                      <a href="{{route('books.index')}}" class="btn btn-lg btn-warning fw-bold text-white mt-4">All Books</a>
                    </div>
                  </div>
            </div>
            <div class="col-4">
                <div class="card pb-4">
                    ...
                    <div class="card-body mt-5 pt-5">
                      ...
                      <a href="{{route('authors.index')}}" class="btn btn-lg btn-primary fw-bold mt-4">All Authors</a>
                    </div>
                  </div>
            </div>
            <div class="col-4">
                <div class="card pb-4">
                    ...
                    <div class="card-body mt-5 pt-5">
                      ...
                      <a href="{{route('categories.index')}}" class="btn btn-lg btn-danger fw-bold mt-4">All Categories</a>
                    </div>
                  </div>
            </div>
        </div>
